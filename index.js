...
client.on('interactionCreate', async interaction => {
  ...
  if (commandName === 'leaderboard') {
    ...
    const wrCount = String(player.wrCount || '0');
    const top7Count = String(player.top7Count || '0');
    const top100Count = String(player.top100Count || '0');
    const totalPoints = player.totalPoints.toLocaleString() || '0';
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields(
        ...
        { name: 'Top 7s', value: top7Count, inline: true },
        { name: 'Top 100s', value: top100Count, inline: true },
        {
